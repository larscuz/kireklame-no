...
export const metadata = siteMeta({
  title: "Prompt-utvider for KI-akademi | Norsk Prompting",
  description:
    "Bruk Prompt-utvider i KI-akademi og Norsk Prompting for å trene prompting i praksis. Skriv en idé og få et sterkere utgangspunkt for KI undervisning, mediefag og generativ produksjon.",
    ...
    >
      <section className="np-node-surface rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))]/88 p-5 md:p-6">
        <p className="text-sm leading-relaxed text-[rgb(var(--muted))]">
          ...
          nyttig i KI-akademi, generativ KI-arbeid og mediefag når du vil forbedre
