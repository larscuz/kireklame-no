...
export default function CompanyCard({ company }: { company: CompanyCardModel }) {
  ...
  return (
    <Link
      href={`/selskap/${company.slug}`}
      className="group rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] shadow-soft hover:shadow-lift transition overflow-hidden"
    >
