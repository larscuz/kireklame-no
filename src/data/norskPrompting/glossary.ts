...
const seeds: Seed[] = [
  ...
  {
    term_no: "Produkthero-lys",
    term_en: "Product hero lighting",
    domain: "photo",
    definition_no: "Lysoppsett som fremhever produktets form, kantdefinisjon og nøkkeldetaljer i kommersielt uttrykk.",
    promptImpact: "Øker tydelighet i packshot og reduserer flat, udefinert produktpresentasjon.",
  },
  {
    term_no: "Teksturseparasjon",
    term_en: "Texture separation",
    domain: "photo",
    definition_no: "Bevisst skille i lys og kontrast mellom materiallag slik at teksturer leses hver for seg.",
    promptImpact: "Forhindrer at overflater flyter sammen og gir mer presis materialgjengivelse.",
  },
  {
    term_no: "Typografisk rasterlås",
    term_en: "Typographic grid lock",
    domain: "design",
    definition_no: "Låsing av tekstplassering mot et fast raster for konsistent hierarki på tvers av varianter.",
    promptImpact: "Stabiliserer layout og reduserer tilfeldig typografidrift mellom outputs.",
  },
  {
    term_no: "Visuell hierarkilinje",
    term_en: "Visual hierarchy line",
    domain: "design",
    definition_no: "Definert prioriteringsrekkefølge for hva som skal leses først, deretter sekundært og tertiært.",
    promptImpact: "Gjør budskap raskere lesbart ved å styre blikkbanen eksplisitt.",
  },
  {
    term_no: "CTA-hierarki",
    term_en: "CTA hierarchy",
    domain: "design",
    definition_no: "Prioritering av handlingsutløsende tekst og elementer slik at neste handling blir entydig.",
    promptImpact: "Øker konverteringsklarhet i sosiale formater og redaksjonelle leveranser.",
  },
  {
    term_no: "Stilanker",
    term_en: "Style anchor",
    domain: "ai",
    definition_no: "Et fast definert sett med stilparametere som skal gjenbrukes uendret gjennom en serie.",
    promptImpact: "Reduserer stilglidning og gir mer gjenkjennelig visuell identitet.",
  },
  {
    term_no: "Instruksjonsprioritet",
    term_en: "Instruction priority",
    domain: "ai",
    definition_no: "Eksplisitt rangering av hva modellen skal vekte høyest ved konflikt mellom instrukser.",
    promptImpact: "Begrenser tolkingsrom og gir mer forutsigbar etterlevelse av viktige krav.",
  },
  {
    term_no: "Promptkontrakt",
    term_en: "Prompt contract",
    domain: "ai",
    definition_no: "En tydelig avtale i prompten om hva som er låst, hva som kan variere og hva som er forbudt.",
    promptImpact: "Forbedrer kontroll i iterative løp ved å holde spesifikasjon og output tett koblet.",
  },
  {
    term_no: "Begrepslås",
    term_en: "Term lock",
    domain: "ai",
    definition_no: "Regel om at nøkkelbegreper skal brukes konsekvent uten tilfeldig omskriving.",
    promptImpact: "Gir høyere semantisk stabilitet i tekst, voiceover og prompt-kjeder.",
  },
  {
    term_no: "Shotliste",
    term_en: "Shot list",
    domain: "film",
    definition_no: "Strukturert oversikt over planlagte utsnitt, kamerabevegelser og dramatisk funksjon per shot.",
    promptImpact: "Øker produksjonsklarhet og hindrer usammenhengende sekvensbygging.",
  },
  {
    term_no: "J-kutt",
    term_en: "J-cut",
    domain: "film",
    definition_no: "Klippegrep der lyd fra neste scene starter før bildeklippet skjer.",
    promptImpact: "Skaper mykere overgang og tydeligere narrativ rytme i video.",
  },
  {
    term_no: "L-kutt",
    term_en: "L-cut",
    domain: "film",
    definition_no: "Klippegrep der lyd fra forrige scene fortsetter over neste bildeklipp.",
    promptImpact: "Holder emosjonell kontinuitet gjennom klipp med mindre opplevd brudd.",
  },
  {
    term_no: "Lydbro",
    term_en: "Sound bridge",
    domain: "film",
    definition_no: "Kontinuerlig lydelement som binder sammen to eller flere bilder eller scener.",
    promptImpact: "Stabiliserer overganger og styrker helhetsopplevelse i korte formater.",
  },
  {
    term_no: "VO-tonekart",
    term_en: "Voiceover tone map",
    domain: "film",
    definition_no: "Definisjon av stemmetone, tempo, energi og artikulasjon for voiceover-leveranser.",
    promptImpact: "Gjør voiceover mer konsistent på tvers av opptak og versjoner.",
  },
  {
    term_no: "Beat-ark",
    term_en: "Beat sheet",
    domain: "film",
    definition_no: "Kort rytmekart over narrative punkter og timing i sekvensen.",
    promptImpact: "Forenkler pacing-kontroll og tydeliggjør dramaturgisk progresjon.",
  },
  {
    term_no: "Matchmove-lås",
    term_en: "Matchmove lock",
    domain: "vfx",
    definition_no: "Låsing av kamerasporing og romkoordinater før kompositt og effekter legges på.",
    promptImpact: "Reduserer glidning mellom plate og VFX-elementer i komplekse shots.",
  },
  {
    term_no: "Plate clean-up",
    term_en: "Plate cleanup",
    domain: "vfx",
    definition_no: "Rensing av uønskede elementer i originalplate før videre VFX-arbeid.",
    promptImpact: "Forhindrer artefakter i senere compositing-trinn og gir renere grunnlag.",
  },
  {
    term_no: "Temporal denoise",
    term_en: "Temporal denoise",
    domain: "vfx",
    definition_no: "Støyreduksjon som tar hensyn til flere frames for å bevare detaljer over tid.",
    promptImpact: "Demper flimring uten å gjøre bevegelige detaljer plastiske.",
  },
  {
    term_no: "Grunn dybdeskarphet",
    term_en: "Shallow depth of field",
    domain: "photo",
    definition_no: "Smal fokusdybde der subjektet er skarpt og bakgrunn holdes mykere.",
    promptImpact: "Øker subjektseparasjon og reduserer bakgrunnsstøy i kommersielle bilder og klipp.",
  },
  {
    term_no: "Dyp fokus",
    term_en: "Deep focus",
    domain: "photo",
    definition_no: "Stor fokusdybde der forgrunn, mellomgrunn og bakgrunn bevares skarpe.",
    promptImpact: "Forbedrer romlig lesbarhet når miljøinformasjon er viktig for historien.",
  },
  {
    term_no: "Fokusskift",
    term_en: "Rack focus",
    domain: "film",
    definition_no: "Kontrollert flytting av fokus mellom to plan i samme shot.",
    promptImpact: "Styrer oppmerksomhet narrativt uten å bytte utsnitt eller bryte kontinuitet.",
  },
  {
    term_no: "Gylden time",
    term_en: "Golden hour",
    domain: "photo",
    definition_no: "Lysforhold rundt soloppgang eller solnedgang med varm tone og mykere skygger.",
    promptImpact: "Gir organisk varme og mer flatterende kontrast i både produkt- og miljøscener.",
  },
  {
    term_no: "Motlys",
    term_en: "Backlighting",
    domain: "photo",
    definition_no: "Lysretning der hovedlyset kommer bak motivet og former kantseparasjon.",
    promptImpact: "Skaper silhuett, atmosfære og tydelig separasjon fra bakgrunn når eksponering kontrolleres.",
  },
  {
    term_no: "Vidvinkel",
    term_en: "Wide-angle lens",
    domain: "film",
    definition_no: "Kort brennvidde som utvider romopplevelse og fremhever perspektivlinjer.",
    promptImpact: "Gir sterk miljøforankring og dynamisk romfølelse i etablerende eller dokumentariske utsnitt.",
  },
];
